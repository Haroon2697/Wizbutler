...
export function Footer() {
  ...
  return (
    <footer className="bg-[#43217a] dark:bg-background/95 backdrop-blur-xl border-t border-glass-border/30 py-16 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              />
              <div>
                <div className="text-xl font-bold text-white dark:text-[#fe9e01] font-sans">
                  WizButler
                </div>
                <div className="text-sm text-white/80 dark:text-muted-foreground font-sans">
                  Space Management Platform
                </div>
              </div>
            </div>
            <p className="text-white/80 dark:text-muted-foreground leading-relaxed font-sans">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-lg font-bold text-white dark:text-[#43217a] font-sans">Contact</h3>
            <div className="space-y-4">
              <a
                href="mailto:joyce@synergysrestaurantgroup.com"
                className="flex items-center space-x-3 text-white/80 dark:text-muted-foreground hover:text-white dark:hover:text-primary transition-colors magnetic dark:hover:text-yellow-400 font-sans"
              >
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-lg font-bold text-white dark:text-[#43217a] font-sans">Quick Links</h3>
            <div className="space-y-3">
              {["Features", "Demo", "Contact", "Privacy Policy", "Terms of Service"].map((link) => (
                <a
                  key={link}
                  href={`#${link.toLowerCase().replace(" ", "-")}`}
                  className="block text-white/80 dark:text-muted-foreground hover:text-white dark:hover:text-[#fe9e01] transition-colors magnetic text-sm font-sans"
                >
                  {link}
                </a>
              ))}
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-lg font-bold text-white dark:text-[#43217a] font-sans">Follow Us</h3>
            ...
            <p className="text-xs text-white/60 dark:text-muted-foreground font-sans">
              Stay updated with the latest WizButler news and venue management insights.
            </p>
            <a href={newsletterUrl} className="inline-block mt-2 text-sm underline text-white/80 dark:text-muted-foreground hover:text-white dark:hover:text-[#fe9e01] font-sans">
        ...
        >
          <p className="text-sm text-white/80 dark:text-muted-foreground font-sans">
            © 2024 WizButler. All rights reserved.
          </p>
          <p className="text-sm text-white/80 dark:text-muted-foreground mt-4 md:mt-0 font-sans">
