      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {venueTypes.map((venue, index) => (
            <motion.div
              ...
              className="bg-white dark:glass-card p-6 rounded-2xl magnetic group shadow-[0_0_20px_rgba(0,0,0,0.1)] dark:shadow-[0_0_25px_rgba(251,191,36,0.2)] hover:shadow-[0_0_30px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_0_35px_rgba(251,191,36,0.4)]"
            >
              ...
              <h3 className="text-xl font-bold mb-4 text-[#43217a] dark:text-[#43217a] group-hover:text-[#fe9e01] dark:group-hover:text-[#8b5e2] transition-all duration-300 font-sans">
                {venue.title}
              </h3>
              ...
              <ul className="space-y-3">
                {venue.features.map((feature, featureIndex) => (
                  <motion.li
                    ...
                    className="flex items-start text-sm text-muted-foreground dark:text-muted-foreground font-sans"
                  >
                    <div className="w-2 h-2 rounded-full bg-[#43217a] dark:bg-[#43217a] mr-3 mt-2 flex-shrink-0" />
                    <span>{feature}</span>
                  </motion.li>
                ))}
              </ul>
        ...
        >
          ...
          <motion.button 
            ...
            className="btn-neon px-8 py-4 text-lg bg-[#fe9e01] dark:bg-[#fe9e01] text-white border-2 border-[#43217a] dark:border-[#43217a] shadow-[0_0_20px_rgba(254,158,1,0.3)] dark:shadow-[0_0_20px_rgba(254,158,1,0.3)] hover:bg-[#43217a] dark:hover:bg-[#43217a] hover:border-[#fe9e01] dark:hover:border-[#fe9e01] hover:shadow-[0_0_30px_rgba(67,33,122,0.5)] dark:hover:shadow-[0_0_30px_rgba(67,33,122,0.5)] hover:shadow-[0_0_40px_rgba(254,158,1,0.8)] dark:hover:shadow-[0_0_40px_rgba(254,158,1,0.8)] font-sans"
          >
