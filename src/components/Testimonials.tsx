      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Quote */}
              <blockquote className="text-lg text-muted-foreground mb-6 leading-relaxed font-sans italic">
                "{testimonial.quote}"
              </blockquote>

              {/* Author */}
              <div className="border-t border-glass-border/30 pt-6">
                <div className="font-bold text-foreground text-lg font-sans">{testimonial.author}</div>
                <div className="text-muted-foreground font-sans">{testimonial.role}</div>
                <div className="text-[#fe9e01] font-semibold font-sans">{testimonial.company}</div>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="glass-card px-8 py-6 inline-block border-blue-400/30 shadow-[0_0_15px_rgba(59,130,246,0.1)] dark:border-yellow-400/30 dark:shadow-[0_0_15px_rgba(251,191,36,0.1)]">
            <h3 className="text-xl font-bold mb-2 text-[#43217a] font-sans">
              Patented Technology
            </h3>
